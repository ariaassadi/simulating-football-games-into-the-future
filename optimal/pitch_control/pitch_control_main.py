...
if __name__ == "__main__":
    ...
    parser.add_argument('player_data', type=str)
    parser.add_argument('o', type=str)
    args = parser.parse_args()

    player_data = json.loads(args.player_data)
